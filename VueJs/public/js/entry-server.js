...
function PageComponent(name) {
    return {
        render: function render(h) {
            return h('h3', 'Hello from the ' + name + ' page');
        }
    };
}
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
    mode: 'history',
    routes: [{ path: '/', component: PageComponent('Home'), name: 'home' }, { path: '/about', component: PageComponent('About'), name: 'about' }, { path: '/contact', component: PageComponent('Contact'), name: 'contact' }]
}));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_f348271a_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(6);
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_f348271a_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_f348271a_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["b" /* staticRenderFns */],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-f348271a", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
new Promise(function (resolve, reject) {
    __WEBPACK_IMPORTED_MODULE_1__router__["a" /* default */].push(url);
    __WEBPACK_IMPORTED_MODULE_1__router__["a" /* default */].onReady(function () {
        var matchedComponents = __WEBPACK_IMPORTED_MODULE_1__router__["a" /* default */].getMatchedComponents();
        if (!matchedComponents.length) {
            return reject({ code: 404 });
        }
        resolve(__WEBPACK_IMPORTED_MODULE_0__app__["default"]);
    }, reject);
}).then(function (app) {
